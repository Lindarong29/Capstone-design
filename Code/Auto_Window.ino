...
Stepper stepper(stepvalue, 3, 5, 4, 6); // stepper객체 설정
...
[출처] [아두이노] 날씨에 따른 자동 창문 계패기만들기(스텝모터, 미세먼지센서, 빗방울 감지 센서)|작성자 난희
